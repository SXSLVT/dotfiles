 ...
 */
static char *font = "JetBrains Mono:weight=900:pixelsize=15:antialias=true:autohint=true";
...
float grad_alpha = 0.5; //alpha value that'll change
float stat_alpha = 0.5; //constant alpha value that'll get added to grad_alpha
