...
// static char *font = "Sony fixed:weight=900:pixelsize=14:antialias=true:autohint=true:hintstyle=rgba";
// static char *font = "Lavender:size=16:antialias=true:autohint=true:hintstyle=rgba:rgba=rgb";
#if FONT2_PATCH
/* Spare fonts */
static char *font2[] = {
...
float grad_alpha = ALPHA_INT; //alpha value that'll change
float stat_alpha = ALPHA_INT; //constant alpha value that'll get added to grad_alpha
...
static Geometry geometry = PixelGeometry; // or PixelGeometry to use the below size
